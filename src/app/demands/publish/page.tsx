    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 pt-16">
        <div className="glass rounded-2xl p-12 text-center max-w-md">
          ...
          <p className="text-sm text-gray-500 mb-6">您需要登录后才能发布需求</p>
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-2xl mx-auto px-4">
        <div className="glass rounded-2xl p-8">
          <h1 className="text-2xl font-bold gradient-text mb-8 text-center">发布商业需求</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <input
                type="text"
                {...register('title', { required: '请输入需求标题' })}
                placeholder="输入需求标题"
            ...
            <div>
              ...
              <textarea
                {...register('description', { required: '请输入需求描述' })}
                placeholder="详细描述您的商业需求"
                rows={5}
